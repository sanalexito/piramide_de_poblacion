...
Esto es algo que sí pude hacer y es el código que les comparto en el script llamado "piramide.R" en donde se usa una base de la Encuesta Nacional de Acceso a la Información y Protección de Datos (ENAID) del INEGI.
